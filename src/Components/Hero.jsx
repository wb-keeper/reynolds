...
function Hero(props) {
  return (
    <section className="section h-[80vh] xl:h-[850px]" id="home">
      <div className="container mx-auto h-full flex justify-center items-center xl:justify-start">
        <div className="h-full flex flex-col justify-center items-center xl:items-start z-20 pt-12">
          ...
          >
            ...
            <div className="hidden xl:flex items-center justify-self-center relative w-7 h-7 mx-4">
              <Image src={"/assets/hero/mic.svg"} fill alt="mic" />
            </div>
            <TypeAnimation
